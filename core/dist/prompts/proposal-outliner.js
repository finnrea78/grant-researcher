...
- If the funder file was not yet harvested (still shows "Pending"), stop and report: "Run \`grant-scout scan\` first to populate the funder file for [funder]."
`.trim();
//# sourceMappingURL=proposal-outliner.js.map